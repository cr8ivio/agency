...
- `packages/@cr8ivio/core`: Core React components
- `packages/@acme/utils`: Shared React utilities
- `packages/@cr8ivio/tsconfig`: Shared `tsconfig.json`s used throughout the Turborepo
- `packages/eslint-config-cr8ivioe`: ESLint preset
